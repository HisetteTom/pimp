...
I. Contexte
Dans le cadre de leur formation, les étudiants réalisent des projets en groupe encadrés par des
enseignants. L’objectif est de concevoir une application web permettant de faciliter la gestion
des projets, la collaboration et le suivi pédagogique.
II. Objectifs du projet
Développer une application web permettant :
• Aux étudiants : gérer leur projet, suivre leur progression, collaborer.
• Aux encadrants : superviser tous les groupes, suivre l’avancement, détecter les
difficultés.
III. Utilisateurs
• Étudiant
• Team Leader
